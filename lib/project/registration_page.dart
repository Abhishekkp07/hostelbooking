    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            Text("SIGN UP",style: TextStyle(fontSize: 30,fontWeight: FontWeight.w900,color: Colors.white, ),),
            SizedBox(height: 10,),
            Text("Just a few quick things to get started",style: TextStyle(fontSize:18,color: CupertinoColors.white),),
            SizedBox(height:40,),
            Padding(
            ...
            MaterialButton(
              ...
              child: Text("Create account",style: TextStyle(color: Colors.white,fontWeight: FontWeight.w700),),
            ),
            SizedBox(height: 30),
